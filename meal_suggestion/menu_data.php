<?php
// FILE DỮ LIỆU MÓN ĂN - ĐÃ CẬP NHẬT ĐỊNH LƯỢNG CHI TIẾT

$foodDatabase = [
    "lose" => [ // GIẢM CÂN (Khẩu phần nhỏ, nhiều rau, ít tinh bột)
        "breakfast" => [
    ...
    "keep" => [ // GIỮ CÂN (Ăn uống cân bằng, khẩu phần tiêu chuẩn)
        "breakfast" => [
    ...
    "gain" => [ // TĂNG CÂN (Khẩu phần lớn, nhiều đạm và tinh bột)
        "breakfast" => [
